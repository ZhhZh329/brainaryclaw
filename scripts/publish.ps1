...
try {
  ...
  if (-not $env:WEEKREP_ANALYZE_TYPES) { $env:WEEKREP_ANALYZE_TYPES = "weekly-score,longitudinal,person-horizontal,week-horizontal,week-briefing,month-horizontal,innovation-week" }
